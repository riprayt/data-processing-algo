...
This is a web-based demonstration that illustrates the **Greedy Cashier Algorithm** - a classic example of greedy algorithms in computer science. The demo simulates serving $5 lemonade with payments in {5,10,20,50,100}, and now lets you seed the register with initial bill counts when testing scenarios.
...
In this demo, change is made **before** accepting the incoming bill, and you can optionally set an initial register state such as `5:2,10:1,20:0,50:0,100:0` (leave empty for zeros).
